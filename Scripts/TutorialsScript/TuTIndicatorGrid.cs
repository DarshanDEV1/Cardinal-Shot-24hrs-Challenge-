...
class GraphIndicatorTut
{
    private Button[,] _buttons;
    private int _rows;
    private int _cols;

    public GraphIndicatorTut(Button[,] buttons)
    {
        _buttons = buttons;
...
public class TuTIndicatorGrid : MonoBehaviour
{
    ...
    {
        GraphIndicatorTut graph = new GraphIndicatorTut(buttons);
