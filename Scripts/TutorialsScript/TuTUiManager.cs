...
namespace DT_UI_TUTORIAL
{
    ...
    public class TuTUIManager : MonoBehaviour
    {
        ...
        [SerializeField] private List<UiButtonTuT> uiButton = new List<UiButtonTuT>();
        private Dictionary<string, Button> uiButtonDictionary = new Dictionary<string, Button>();

        [Header("InputField References")]
        [SerializeField] private List<UiInputFieldTuT> uiInputField = new List<UiInputFieldTuT>();
        private Dictionary<string, TMP_InputField> uiInputFieldDictionary = new Dictionary<string, TMP_InputField>();

        [Header("GameObjects References")]
        [SerializeField] private List<UiGameObjectTuT> uiGameObject = new List<UiGameObjectTuT>();
        ...
        private void UpdateButtonDictionary()
        {
            ...
            foreach (UiButtonTuT uiReference in uiButton)
            {
        ...
        private void UpdateInputFieldDictionary()
        {
            ...
            foreach (UiInputFieldTuT uiReference in uiInputField)
            {
        ...
        private void UpdateGameObjectDictionary()
        {
            ...
            foreach (UiGameObjectTuT uiReference in uiGameObject)
            {
